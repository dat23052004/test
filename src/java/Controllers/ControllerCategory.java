...
public class ControllerCategory extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("list_book_category", bookDA.getBooksByCategoryId(id));
        request.setAttribute("quanlity_book_category", bookDA.getQuantityByCategoryId(id));
        request.setAttribute("category_current", cateDA.getCategoryById(id));
